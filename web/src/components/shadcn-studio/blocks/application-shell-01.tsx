...
export function ApplicationShell({ children }: ApplicationShellProps) {
  ...
  return (
    <div className="min-h-screen bg-background flex">
      <aside className="w-[240px] flex flex-col fixed inset-y-0 z-50 hidden lg:flex">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="hidden sm:flex items-center gap-2 bg-secondary/50 rounded-lg px-3 py-2">
                ...
                <input
                  type="text"
                  placeholder="Search..."
                  className="bg-transparent border-0 outline-none text-sm text-white placeholder:text-muted-foreground w-48"
                />
              </div>
            </div>
